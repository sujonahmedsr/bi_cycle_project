...
const userNavItems = [
  { title: 'Admin Dashboard', icon: <FaHome />, link: '/adminDashboard' },
  { title: 'All Products', icon: <MdGridView />, link: '/adminDashboard/allProducts' },
  { title: 'All Users', icon: <FaUsers />, link: '/adminDashboard/allUsers' },
  { title: 'All Orders', icon: <MdGridView />, link: '/adminDashboard/allOrders' },
  { title: 'Profile Settings', icon: <FaUser />, link: '/adminDashboard/profileSetting' },
  { title: 'Update Password', icon: <IoMdSettings />, link: '/adminDashboard/updatePassword' },
];
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`fixed md:relative bg-white md:w-64 w-72 h-full shadow-md transform ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 transition-transform duration-300 z-50 md:sticky md:top-0 md:h-screen`}>
        ...
        <ul className="mt-4 px-4 overflow-y-auto h-[calc(100vh-4rem)]">
