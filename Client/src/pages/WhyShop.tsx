            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 gap-5">
                <div className="p-10 flex items-center justify-between flex-col text-center border shadow space-y-3 bg-blue-50 rounded-md w-full">
                    ...
                    <Link to={'/about'} className="w-full">
                        <Button variant={"ghost"} className="w-full mt-5 rounded-none hover:bg-blue-700 hover:text-white">About Us →</Button>
                    </Link>
                </div>
                <div className="p-10 flex items-center justify-between flex-col text-center border shadow space-y-3 bg-blue-50 rounded-md">
                    ...
                    <Link to={'/shop'} className="w-full">
                        <Button variant={"ghost"} className="w-full mt-5 rounded-none hover:bg-blue-700 hover:text-white">Shop Now →</Button>
                    </Link>
                </div>
                <div className="p-10 flex items-center justify-between flex-col text-center border shadow space-y-3 bg-blue-50 rounded-md">
                    ...
                    <Link to={'/contact'} className="w-full">
                        <Button variant={"ghost"} className="w-full mt-5 rounded-none hover:bg-blue-700 hover:text-white">Contact Us →</Button>
                    </Link>
                </div>
                <div className="p-10 flex items-center justify-between flex-col text-center border shadow space-y-3 bg-blue-50 rounded-md">
                    ...
                    <Link to={'/contact'} className="w-full">
                        <Button variant={"ghost"} className="w-full mt-5 rounded-none hover:bg-blue-700 hover:text-white">More Info →</Button>
                    </Link>
                </div>
            </div>
        </div>
